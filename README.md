...
- `manifest.json` - update manifest consumed by the launcher
- `configs/ModsConfig.xml` - canonical active mod list and order
- `BUILDING.md` - how to zip and publish updated assets
